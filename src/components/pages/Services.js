...
const Services = ({ img1, img2 }) => {
  return (
    <article id="Services" className="wrapper serv_article">
      ...
      <div className="flex_wrap handleContent">
        <div>
          ...
          <ul className="list_services">
            <li> Website Development </li> <li> User Experience Design </li>{" "}
            <li> Responsive Design </li> <li> SEO </li>{" "}
          </ul>{" "}
        </div>{" "}
        <div>
          ...
          <ul className="list_services">
            ...
            <li> Avaloq Core Banking </li> <li> SQL </li>{" "}
          </ul>{" "}
        </div>{" "}
      </div>{" "}
    </article>
